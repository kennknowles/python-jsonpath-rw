...
| ``[`` *field* ``]``                                   | Same as *field*                                                                           |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[`` *idx* ``]``                                     | Array access by index, described below (this is always unambiguous with field access)     |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[`` ?*filter* ``]``                                 | Array access with filter, described below                                                 |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[``\ ``\\`` *jsonpath*\ ``]``                       | Ascending sorted version of an array (may be comma-separated list)                        |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[``\ ``/`` *jsonpath*\ ``]``                        | Descending sorted version of an array (may be comma-separated list)                       |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[``\ ``/`` *jsonpath*\ ,\ *jsonpath*\ ``]``         | Descending sorted version of an array where a second jsonpath is used for the comparaison |
|                                                       | if the first doesn't exists                                                               |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+
| ``[``\ ``/`` *jsonpath*\ ,\ ``//``\ *jsonpath*\ ``]`` | Sorted version of an array according multiple sort orders                                 |
+-------------------------------------------------------+-------------------------------------------------------------------------------------------+

*Note: array are sorted using Python comparaison*
...
| Syntax                                                    | Meaning                                                                                       |
+===========================================================+===============================================================================================+
| ``[``\ ``?``\ *jsonpath*\ ``]``                           | Array with row where the jsonpath exists                                                      |
+-----------------------------------------------------------+-----------------------------------------------------------------------------------------------+
| ``[``\ ``?``\ *jsonpath*\ ``operator``\ *constant*\ ``]`` | Array with row where the jsonpath value *operator* than *constant*' (may be &-seprated list), |
|                                                           | Operator can be '=, ==, !=, <, <=, >, >=' (ex: *[?(@.some.field>=4&other.field<2)]*)          |
+-----------------------------------------------------------+-----------------------------------------------------------------------------------------------+
